...
class DatabaseDataset(Dataset):
    def __init__(self, db_name=None, datapoint_ids=None, encoders=None):
        ...
        all_dps_present = (
            len(os.listdir(self.data_dir))
            == self.db_info["task"]["n_train"] + self.db_info["task"]["n_test"]
        )
                ...
                if feature_info["type"] == "CATEGORICAL":
                    ...
                    if s_enc == "ScalarRobustScalerEnc":
                        ...
                        enc = ScalarPowerTransformerEnc(
                            feature_info["PowerTransformer_lambdas_"],
                        ...
                        enc = ScalarQuantileTransformerEnc(
                            feature_info["QuantileTransformer_n_quantiles_"],
                        ...
                        enc = ScalarQuantileOrdinalEnc(
                            feature_info["KBinsDiscretizer_n_bins_"],
                    ...
                    if t_enc == "TfidfEnc":
                        enc = TfidfEnc(
                            feature_info["Tfidf_vocabulary_"],
