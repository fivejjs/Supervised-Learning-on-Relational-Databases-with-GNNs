...
class GIN(GNNModelBase):
    ...
    def __init__(
        self, n_apply_func_layers, aggregator_type, init_eps, learn_eps, **kwargs
    ):
...
class RelationalGINConv(GINConv):
    def __init__(
        ...
        self.act = activation
        self.edge_message_layer = TypeConditionalLinear(
            hidden_dim, hidden_dim, num_rels
        )
...
class ERGIN(RelationalGIN):
    ...
    def __init__(
        ...
        super().__init__(
            n_apply_func_layers, aggregator_type, init_eps, learn_eps, **kwargs
        )
            ...
            self.apply_func_blocks.append(
                nn.ModuleList(
                    [
                        nn.ModuleDict(
                            {
                                "tcl": TypeConditionalLinear(
                                    self.hidden_dim, self.hidden_dim, self.n_node_types
                                ),
                                "act": self.get_act(),
